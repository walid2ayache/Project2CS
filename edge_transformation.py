...
# ── CHANGE (Option C) ────────────────────────────────────────────────────────
# Replaced 'VFW' and 'VEB' with 'OTH'.
# signal2image.py now writes all former VFW and VEB beat images into an "OTH"
# subfolder, so edge_transformation must look for "OTH" — not "VFW"/"VEB".
# ─────────────────────────────────────────────────────────────────────────────
ECG_CLASSES = ['NOR', 'PVC', 'PAB', 'LBB', 'RBB', 'APC', 'OTH']
